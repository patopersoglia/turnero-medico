...
@WebServlet("/VerTurnosServlet")
public class VerTurnosServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(VerTurnosServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int entityId = usuario.getId_usuario();
        ...
        try {
            ...
            if ("administrador".equals(tipoUsuario)) {
                ...
                query = """
                    ...
                    WHERE t.id_medico = ? AND t.fecha_turno >= CURDATE()
                    ORDER BY t.fecha_turno, t.hora_turno
                """;
                ps = con.prepareStatement(query);
                ...
                query = """
                    ...
                    WHERE t.id_paciente = ? AND t.fecha_turno >= CURDATE()
                    ORDER BY t.fecha_turno, t.hora_turno
                """;
                ps = con.prepareStatement(query);
                ps.setInt(1, entityId);
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    turno.setHora_Turno(rs.getString("hora_turno"));
            ...
            LOGGER.log(Level.INFO, "Turnos futuros obtenidos exitosamente para usuario {0} (rol: {1})", 
